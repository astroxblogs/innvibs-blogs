...
const generateSlugsForExistingBlogs = async () => {
    try {
        // Connect to MongoDB
        ...
        for (const blog of blogsWithoutSlugs) {
            ...
            blog.slug = slug;
            await blog.save();
            console.log(`Generated slug "${slug}" for blog "${title}"`);
        }
...
module.exports = { generateSlugsForExistingBlogs, generateUniqueSlug };
